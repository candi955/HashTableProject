...
class Hashing:
    ...
    def newNum(self):
        ...
        rand1000 = random.sample(range(1, 1001), 1)

        randomUpdateNum = random.sample(range(1, 255), 5)
        randomUpdateNumBytes = bytes(randomUpdateNum)

        dataRandom = np.append(dataEmpty, [rand1000])
        print("\nPlacing 1,000 random numbers into the dataset:\n", dataRandom)
        ...
        for item in dataRandomBytes:
            ...
            print("\nAdding a hash to the 1,000 dataset numbers:\n", itemHashed_and_Salted)
    ...
    def newNumPrint(self):
        ...
        # The hashes were all showing up as same hash and salt, so created the function and now calling the function 1000 times
        # reference: https://stackoverflow.com/questions/4264634/more-pythonic-way-to-run-a-process-x-times
        # the range (1000) at the current setup within this python version and IDE, is creating 1000 hashes
        ...
        print("\n1,000 values have been added.\n")
        print("\nThe timing it took to add 1,000 random values with hashes/salt to the excel file is",
    ...
    def _getInfo_(self):
        ...
        if a is not None:
            ...
            print('Printing the requested hashed key and assigned random 1,000 number value:\n', keyRow, "\n")
        ...
        if deleteRequ == "Yes":
            ...
            if doubleChecking == "Yes":
                ...
                if reader.empty == False:
                    ...
                    print("\nThe timing it took to delete 1,000 random values with hashes/salt from the excel file is",
...
def main():
    ...
    asking = input("Please make a choice.\n"+
                   "1 to make an entry of 1,000 numbers onto the excel file\n" +
